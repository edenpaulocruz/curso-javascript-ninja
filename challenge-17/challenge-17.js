(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Eden Paulo Damascena da Cruz'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'soteropolitano'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function(textCapture) {
    return textCapture.toUpperCase();
  }))
